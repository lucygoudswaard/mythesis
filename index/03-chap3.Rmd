...
```{r Linear-reg-MR, echo = FALSE , fig.cap="(ref:caption-Linear-reg-MR)", out.width = "80%", fig.scap = "(ref:scaption-Linear-reg-MR)"}
...
```{r confounder-platelets, echo = FALSE, fig.scap="(ref:scaption-confounder-platelets)", fig.cap="(ref:caption-confounder-platelets)", out.width="80%"}
...
mytable %>% kable(caption.short = "(ref:scaption-BMI-platelets-stratified)", format = "latex", caption = "(ref:caption-BMI-platelets-stratified)", booktabs = TRUE  ) %>% 
  kable_classic_2(full_width = F) %>%
 kable_styling(full_width = TRUE) %>%
...
mytable %>% kable(caption = "(ref:caption-BMI-platelets-COPTIC)", format = "latex", caption.short="(ref:scaption-BMI-platelets-COPTIC)", booktabs = TRUE) %>% 
  kable_classic_2(full_width = F) %>%
 kable_styling(full_width = TRUE) %>%
  landscape()
```
