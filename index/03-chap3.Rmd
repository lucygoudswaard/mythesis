...
```{r BMI-platelet-overview, echo = FALSE , fig.scap="(ref:scaption-BMI-platelet-overview)", fig.cap="(ref:caption-BMI-platelet-overview)", out.width="90%"}
include_graphics(path = "figure/BMI_platelets/Thesis_graphic_overview_BMI_platelets.png", dpi = NA)
```

(ref:caption-Linear-reg-MR) **Schematic of linear regression and Mendelian randomization analyses. Linear regression assesses the association between BMI (exposure) and platelet traits (outcome), with adjustment for potential confounders.** Under the assumptions of Mendelian randomization (MR), the genetic risk score (GRS) for body mass index (BMI) does not associate with confounding variables, and if there is a causal association, the GRS should only associate with platelet outcomes through its association with body mass index.
(ref:scaption-Linear-reg-MR) Schematic of linear regression and Mendelian randomization frameworks for BMI and platelet trait analyses
```{r Linear-reg-MR, echo = FALSE , fig.cap="(ref:caption-Linear-reg-MR)", fig.scap = "(ref:scaption-Linear-reg-MR)"}
...
```{r INTERVAL-STROBE, echo = FALSE, out.width="60%", fig.cap="(ref:caption-INTERVAL-STROBE)", fig.scap="(ref:scaption-INTERVAL-STROBE)"}
...
Units <- c('%','%','10^9^/L','10^9^/L','%','fL','10^9^/L','%','fL','RFUs','RFUs','RFUs')
...
mytable %>% kable(caption = "(ref:caption-Platelet-traits)", booktabs = TRUE, format = "markdown", caption.short = "(ref:scaption-Platelet-traits)") %>% 
...
mytable %>% kable(caption = "(ref:caption-INT-participants-platelets)", caption.short = "(ref:scaption-INT-participants-platelets)", booktabs = TRUE) %>% 
  kable_classic_2(full_width = F) %>%
...
```{r Corr-mat-dend, echo = FALSE, out.width="95%", fig.cap="(ref:caption-Corr-mat-dend)", fig.scap= "(ref:scaption-Corr-mat-dend)"}
...
colnames(mytable) <- c('Platelet trait',	'N',	'Βeta coefficient',	'SE',	'P value',	'R^2^',	'Eta^2^',	'95% CI',	'Lower 95% CI',	'Upper 95% CI')
mytable %>% kable(caption = "(ref:caption-BMI-platelets-adjust)", booktabs = TRUE, format = "markdown", caption.short = "(ref:scaption-BMI-platelets-adjust)") %>% 
  kable_classic_2(full_width = F) %>%
 kable_styling(full_width = TRUE) %>%
  landscape()
```
...
colnames(mytable) <- c('Full name', 'Short Name',	'N',	'Βeta coefficient',	'SE',	'P value',	'R^2^',	'Eta^2^',	'95% CI',	'Lower 95% CI',	'Upper 95% CI')
mytable %>% kable(caption = "(ref:caption-BMI-platelets-unadjust)", booktabs = TRUE,  format = "markdown", caption.short = "(ref:scaption-BMI-platelets-unadjust)") %>% 
  kable_classic_2(full_width = F) %>%
 kable_styling(full_width = TRUE) %>%
...
mytable %>% kable(caption = "(ref:caption-INT-confounders-BMI-platelets)", booktabs = TRUE, format = "markdown", caption.short = "(ref:scaption-INT-confounders-BMI-platelets)") %>% 
  kable_classic_2(full_width = F) %>%
 kable_styling(full_width = TRUE) %>%
...
```{r confounder-platelets, echo = FALSE, fig.scap="(ref:scaption-confounder-platelets)", fig.cap="(ref:caption-confounder-platelets)", out.width="90%"}
...
(ref:caption-BMI-platelets-MR) **Mendelian randomization estimates for the effect of BMI on platelet traits.** Beta coefficient is the change in platelet measure in SDs per SD higher BMI.
(ref:scaption-BMI-platelets-MR) Mendelian randomization estimates for the effect of BMI on platelet traits
...
colnames(mytable) <- c('Full name', 'Short Name',	'N',	'Βeta coefficient',	'SE',	'P value',	'R^2^',	'Eta^2^',	'95% CI',	'Lower 95% CI',	'Upper 95% CI', "Wu-Hausman P value", 'F-statistic (GRS and BMI association)')
mytable %>% kable(caption = "(ref:caption-BMI-platelets-MR)", booktabs = TRUE, format = "markdown", caption.short = "(ref:scaption-BMI-platelets-MR)") %>% 
  kable_classic_2(full_width = F) %>%
 kable_styling(full_width = TRUE) %>%
...
(ref:scaption-BMI-platelet-forest) Forest plot of the Mendelian randomization and unadjusted observational estimates for the effect of BMI on platelet traits
```{r BMI-platelet-forest, out.width="90%", echo = FALSE, fig.cap="(ref:caption-BMI-platelet-forest)", fig.scap = "(ref:scaption-BMI-platelet-forest)"}
...
options(knitr.kable.NA = "")
f = c("Age", "Sex", "Female", "Male", "Body mass index (kg/m2)", "Smoking", "Never", "Ex-smoker (>5 years)", "Ex-smoker (1-5 years)", "Ex-smoker (30 days to 1 year)", "Current smoker", "Antiplatelet medications", "0", "1", "2", "3", 'ADP aggregation (AU)','Adrenaline aggregation (AU)','Arachidonic acid aggregation (AU)','TRAP-6 aggregation (AU)','Platelet count (x 10^9^/L)','Mean platelet volume (fL)','Immature platelet fraction (%)','Immature platelet count (x 10^9^/L)')
...
mytable %>% kable(caption = "(ref:caption-COPTIC-participants-platelets)", booktabs = TRUE, format = "markdown", caption.short = "(ref:scaption-COPTIC-participants-platelets)") %>% 
  kable_classic_2(full_width = F) %>%
  #kable_paper("hover", full_width = F)
...
colnames(mytable) <- c('Outcome',	'N',	'Βeta coefficient',	'SE',	'P value',	'R^2^',	'95% CI',	'Lower 95% CI',	'Upper 95% CI')
...
```{r IPC-aggregation, echo = FALSE, out.width="85%", fig.cap="(ref:caption-IPC-aggregation)", fig.scap = "(ref:scaption-IPC-aggregation)"}
include_graphics(path = "figure/BMI_platelets/IPC_aggregation.pdf", dpi = NA)

```

(ref:caption-BMI-platelet-cartoon) Graphical summary of findings
```{r BMI-platelet-cartoon, echo = FALSE, out.width="90%", fig.cap="(ref:caption-BMI-platelet-cartoon)"}
