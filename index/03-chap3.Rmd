...
This work is under review at Platelets journal and is on the preprint server MedRXiV [@Goudswaard2021.05.19.21257443]. I performed all analyses, created all figures and tables and wrote the manuscript. 

## Background

Obesity (body mass index ≥ 30 kg/m^2^) has nearly tripled worldwide in the last 45 years [@Bluher2019]. This is a major health concern as a higher body mass index (BMI) is an important risk factor for various noncommunicable disorders, including cardiovascular disease [@Bhaskaran2018a]. Clinical studies and genetic association studies have identified BMI as an independent risk factor for thrombotic disorders, including coronary heart disease and stroke 4-6 [@Nordestgaard2012; @Dale2017; @Wolk2003a]. 
...
### Genetic data and the association of the genetic risk score (GRS) with BMI
The genotyping of INTERVAL participants was performed using the Affymetrix GeneTitan® Multi-Channel (MC) Instrument. Quality control (QC) was performed as previously described [@Astle2016]. Imputation was implemented using a combined 1000 Genomes phase-3-UK + 10K reference panel using the Practical Byzantine Fault Tolerance (PBFT) algorithm [@Astle2016]. A genetic instrument for BMI was created by using 654 genetic variants available of the 656 variants which were independently associated with BMI (P<5x10-8) in a recent meta-analysis of GWAS of around 700,000 individuals of European descent [@Yengo2018]. Of these individuals, 450,000 were from UK Biobank and 250,000 were from the Genetic Investigation of Anthropometric Traits (GIANT) consortium. The weighted GRS was made using PLINK 2.0 [@Purcell2007a]. The effect alleles and beta coefficients were extracted from the source GWAS. The weighted score was calculated by multiplying the dosage of each effect alleles by its effect estimate, summing these and dividing by the number of SNPs (654). The GRS therefore reflects the average per-SNP effect on BMI per individual. 
