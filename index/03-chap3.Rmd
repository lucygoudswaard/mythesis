...
mytable %>% kable(caption = "(ref:caption-Platelet-traits)", booktabs = TRUE, caption.short = "(ref:scaption-Platelet-traits)") %>% 
...
mytable %>% kable(caption = "(ref:caption-BMI-platelets-adjust)", booktabs = TRUE, caption.short = "(ref:scaption-BMI-platelets-adjust)") %>% 
  kable_classic_2(full_width = F) %>%
 kable_styling(full_width = TRUE) %>%
  landscape()
```
...
mytable %>% kable(caption = "(ref:caption-BMI-platelets-unadjust)", booktabs = TRUE, caption.short = "(ref:scaption-BMI-platelets-unadjust)") %>% 
  kable_classic_2(full_width = F) %>%
 kable_styling(full_width = TRUE) %>%
...
mytable %>% kable(caption = "(ref:caption-INT-confounders-BMI-platelets)", booktabs = TRUE, caption.short = "(ref:scaption-INT-confounders-BMI-platelets)") %>% 
  kable_classic_2(full_width = F) %>%
 kable_styling(full_width = TRUE) %>%
...
mytable %>% kable(caption = "(ref:caption-BMI-platelets-MR)", booktabs = TRUE, caption.short = "(ref:scaption-BMI-platelets-MR)") %>% 
  kable_classic_2(full_width = F) %>%
 kable_styling(full_width = TRUE) %>%
...
colnames(mytable) <- c('Adjustment', 'Group', 'BMI range',	'N',	'Beta coefficient',	'SE',	'P value',	'R2',	'95% CI',	'Lower 95% CI',	'Upper 95% CI')
mytable %>% kable(caption.short = "(ref:scaption-BMI-platelets-stratified)", caption = "(ref:caption-BMI-platelets-stratified)", booktabs = TRUE  ) %>% 
  kable_classic_2(full_width = F) %>%
 kable_styling(full_width = TRUE) %>%
...
mytable %>% kable(caption = "(ref:caption-COPTIC-participants-platelets)", booktabs = TRUE, caption.short = "(ref:scaption-COPTIC-participants-platelets)") %>% 
  kable_classic_2(full_width = F) %>%
  #kable_paper("hover", full_width = F)
...
mytable %>% kable(caption = "(ref:caption-BMI-platelets-COPTIC)", caption.short="(ref:scaption-BMI-platelets-COPTIC)", booktabs = TRUE) %>% 
  kable_classic_2(full_width = F) %>%
 kable_styling(full_width = TRUE) %>%
  landscape()
```
