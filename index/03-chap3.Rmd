...
This work is published in the journal Platelets[@Goudswaard2022]. I performed all analyses, created all figures and tables and wrote the manuscript. 
...
```{r BMI-platelet-overview, echo = FALSE , fig.scap="(ref:scaption-BMI-platelet-overview)", fig.cap="(ref:caption-BMI-platelet-overview)", out.width="80%"}
