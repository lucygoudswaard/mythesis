...
include_graphics(path = "figure/BMI_platelets/Thesis_graphic_overview_BMI_platelets_arrows.png", dpi = NA)
```
...
colnames(mytable) <- c('Platelet trait',	'N',	'Beta coefficient',	'SE',	'P value',	'R2',	'Eta2',	'95% CI',	'Lower 95% CI',	'Upper 95% CI')
...
colnames(mytable) <- c('Full name', 'Short Name',	'N',	'Beta coefficient',	'SE',	'P value',	'R2',	'Eta2',	'95% CI',	'Lower 95% CI',	'Upper 95% CI', "Wu-Hausman P value", 'F-statistic (GRS and BMI association)')
