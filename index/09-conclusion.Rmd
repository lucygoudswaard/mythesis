...
```{r Thesis-schematic-chaps, echo = FALSE, out.width = "90%", fig.cap="(ref:caption-Thesis-schematic-chaps)", fig.scap="(ref:scaption-Thesis-schematic-chaps)"}
...
mytable %>% kable(caption = "(ref:caption-main-thesis-findings)", booktabs = TRUE, format="markdown") %>% 
