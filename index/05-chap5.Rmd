...
```{r proteome-lit,  echo=FALSE}
 ...
 column_spec(3, width = "7cm") %>%
   ...
   landscape()
```
There is also overlap between proteins altered with BMI in the current study and transcripts that are reported to be altered with higher BMI [@Freedman2010]. For example, S100A9 (Myeloid-related protein-14 or MRP-14) platelet transcripts were altered with BMI and the levels of the protein were increased in the bariatric group in the current study. Studies in mice have found evidence that S100A9 is involved in thrombus formation [@Wang2014a], and there is evidence for its involvement in myocardial infarction [@Cai2020]. Likewise, myeloperoxidase (MPO) transcripts were associated with BMI and there were higher protein levels in bariatric patients with obesity. A previous study has shown evidence that MPO can potentiate ADP-induced platelet aggregation in PRP [@Gorudko2013].
