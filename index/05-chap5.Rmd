...
include_graphics(path = "figure/Chemokines/Thesis_graphic_overview_chemokines_arrows.png", dpi = NA)
```
...
### Effects of MDC and TARC alone on aggregation in PRP
...
(ref:scaption-plate-agg-chemokines) The effect of the chemokines MDC and TARC alone on aggregation in platelet rich plasma using plate aggregation
(ref:caption-plate-agg-chemokines) **The effect of the chemokines MDC and TARC alone on aggregation in platelet rich plasma using plate aggregation**. A-C) PRP supplemented with apyrase was stimulated with 1uM PAR1-AP, 10uM ADP, 200ng/mL MDC, or 200 ng/mL TARC for 5 mins using a plate shaker. Readings were taken with a plate reader. 
```{r plate-agg-chemokines, out.width="85%", echo = FALSE, fig.cap="(ref:caption-plate-agg-chemokines)", fig.align = "center", fig.scap= "(ref:scaption-plate-agg-chemokines)"}
include_graphics(path = "figure/Chemokines/PRP_MDC_TARC_plate_agg.png", dpi = NA)
