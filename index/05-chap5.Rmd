...
```{r chemokine-platelet-graphic, echo = FALSE , fig.scap="(ref:scaption-chemokine-platelet-graphic)", fig.cap="(ref:caption-chemokine-platelet-graphic)", out.width="90%"}
...
```{r MDC-TARC-agg, echo = FALSE, out.width="85%", fig.cap="(ref:caption3a)", fig.scap= "(ref:scaption3a)"}
...
```{r MDC-TARC-integrin-pselectin, echo = FALSE, out.width="70%", fig.cap="(ref:caption3)", fig.scap= "(ref:scaption3)"}
...
```{r MDC-TARC-wp-WB-VASP, echo = FALSE, out.width="55%", fig.cap="(ref:caption6)", fig.scap= "(ref:scaption6)"}
...
```{r MDC-TARC-wp-VASP-bar, echo = FALSE, out.wdith = "50%", fig.cap="(ref:caption7)", fig.scap= "(ref:scaption7)"}
