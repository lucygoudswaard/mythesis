...
mytable %>% kable(caption = "(ref:caption-obesity-platelets-parameters)", booktabs = TRUE, format = "latex", caption.short = "(ref:scaption-obesity-platelets-parameters)") %>%  kable_classic_2(full_width = F) %>%
  #kable_paper("hover", full_width = F)
 kable_styling(full_width = TRUE) %>%
column_spec(1, width = "5cm")
