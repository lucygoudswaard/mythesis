...
(ref:scaption2) Concentration response curves of integrin activation and P-selectin expression
(ref:caption2) Concentration response curves in diluted PRP of: integrin activation in response to A) PAR1-AP, B) ADP and C) CRP and P-selectin expression in response to D) PAR1-AP, E) ADP, F) CRP. N=4.

```{r agonist-integrin-pselectin, echo = FALSE, fig.cap="(ref:caption2)", fig.scap= "(ref:scaption2)"}
...
```{r platelet-neutrophil, echo = FALSE, fig.cap="(ref:caption2b)", fig.scap= "(ref:scaption2b)"}
