...
(ref:caption-BMI-protein-graphic2) **Schematic of the associations explored in Chapter \@ref(BMI-protein-RCT). This chapter explores the effect of BMI change on the plasma proteome.** Figure made using BioRender.com.
...
include_graphics(path = "figure/DiRECT/Thesis_graphic_overview_BMI_protein_CVD_arrows.png", dpi = NA)
```
