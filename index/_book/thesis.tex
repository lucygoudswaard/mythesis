...
{\centering \includegraphics{figure/Intro_background/Thesis_graphic_overview_without_chapters_extra_arrows} 
...
{\centering \includegraphics[width=0.8\linewidth]{figure/BMI_platelets/Thesis_graphic_overview_BMI_platelets_arrows} 
...
\centering
\begin{tabu} to \linewidth {>{\raggedright\arraybackslash}p{3cm}>{\raggedright\arraybackslash}p{4cm}>{\raggedright\arraybackslash}p{6cm}>{\raggedright}X>{\raggedright}X}
\toprule
...
\toprule
\begin{minipage}[b]{(\columnwidth - 10\tabcolsep) * \real{0.13}}\raggedright
Adjustment\strut
...
\toprule
Outcome & N & Beta coefficient & SE & P value & R\textsuperscript{2} & 95\% CI & Lower 95\% CI & Upper 95\% CI\tabularnewline
\midrule
\endfirsthead
\toprule
Outcome & N & Beta coefficient & SE & P value & R\textsuperscript{2} & 95\% CI & Lower 95\% CI & Upper 95\% CI\tabularnewline
\midrule
\endhead
MPV & 627 & 0.08 & 0.04 & 0.04 & 0.003 & 0.07 & 0.00 & 0.15\tabularnewline
IPC & 622 & 0.06 & 0.04 & 0.09 & 0.013 & 0.07 & -0.01 & 0.14\tabularnewline
PLT & 630 & 0.04 & 0.04 & 0.32 & 0.071 & 0.07 & -0.03 & 0.1\tabularnewline
IPF & 621 & 0.03 & 0.04 & 0.36 & 0.014 & 0.07 & -0.04 & 0.11\tabularnewline
\bottomrule
\end{longtable}
\elandscape
...
{\centering \includegraphics[width=0.9\linewidth]{figure/Bariatric_study/Thesis_graphic_overview_BMI_platelets_arrows} 
...
\toprule
\begin{minipage}[b]{(\columnwidth - 3\tabcolsep) * \real{0.37}}\raggedright
Variable\strut
\end{minipage} & \begin{minipage}[b]{(\columnwidth - 3\tabcolsep) * \real{0.17}}\raggedright
Control mean (SD)\strut
\end{minipage} & \begin{minipage}[b]{(\columnwidth - 3\tabcolsep) * \real{0.26}}\raggedright
Bariatric patient mean (SD)\strut
\end{minipage} & \begin{minipage}[b]{(\columnwidth - 3\tabcolsep) * \real{0.21}}\raggedleft
P value for difference\strut
\end{minipage}\tabularnewline
\midrule
\endfirsthead
\toprule
...
Platelet count (PLT) (10\textsuperscript{9}/L)\strut
...
{\centering \includegraphics[width=0.9\linewidth]{figure/Chemokines/Thesis_graphic_overview_chemokines_arrows} 
...
{\centering \includegraphics[width=0.85\linewidth]{figure/Chemokines/PRP_MDC_TARC_plate_agg} 
...
{\centering \includegraphics[width=0.9\linewidth]{figure/BMI_protein_INTERVAL/Thesis_graphic_overview_BMI_protein_CVD_arrows} 
...
A sensitivity analysis was performed to test whether any BMI-protein effects arise because the SNPs used for the for the BMI GRS are located near the genes which encode the protein outcomes. For proteins which had evidence for a BMI effect, a two sample MR was performed using available summary statistics on MRBase\textsuperscript{\protect\hyperlink{ref-Hemani2018}{169}}. The summary statistics for BMI were obtained from Yengo et al., using the 656 near-independent SNPs associated with BMI in a population of 681275 individuals (the same ones used for the genetic risk score)\textsuperscript{\protect\hyperlink{ref-Yengo2018}{23}}. Summary statistics for proteins were obtained from the GWAS performed by Sun et al.\textsuperscript{\protect\hyperlink{ref-Sun2018}{37}}, where plasma protein levels were measured in SD units in a total of 3301 participants. The overlap between these two GWAS is 0.05\% of UK Biobank participants. A total of 637 of the BMI SNPs were present in the protein summary statistics. The inverse-variance weighted (IVW) method, weighted median and weighted mode MR methods were used to estimate the causal effect using the TwoSampleMR R package\textsuperscript{\protect\hyperlink{ref-Hemani2018}{169},\protect\hyperlink{ref-Burgess2016}{171}}. These methods can be limited by the limited heritability of the protein outcomes, therefore the effects were compared with the one sample MR results. The MR Egger method was also used to estimate the causal effect\textsuperscript{\protect\hyperlink{ref-Burgess2017}{173}}; this method also tests for directional pleiotropy. Pleiotropy was explored using the MR Egger intercept and heterogeneity was examined using Cochran's Q statisitc\textsuperscript{\protect\hyperlink{ref-Burgess2017}{173},\protect\hyperlink{ref-Greco2015}{174}}. Cis protein quantitative trait loci (pQTLs) for each protein were identified\textsuperscript{\protect\hyperlink{ref-Sun2018}{37}} and any BMI SNPs within ± 1 Mb of these loci were removed. The two sample MR estimate was recalculated without these BMI SNPs to determine whether effects still remain after removal of SNPs near the genes which encode the proteins and, where possible, the MR estimates for each protein were compared.
...
\caption[Summary of proteins which have summary statistics available in Sun et al.\textsuperscript{\protect\hyperlink{ref-Sun2018}{37}}, proteins which have cis pQTLs and which pQTLs are within 1 Mb from a BMI SNP]{\label{tab:pQTLs}\textbf{Summary of proteins which have summary statistics available in Sun et al.\textsuperscript{\protect\hyperlink{ref-Sun2018}{37}}, proteins which have cis pQTLs and which pQTLs are within 1 Mb from a BMI SNP}. Any SNPs which need to removed as a sensitivity analysis are highlighted. FABP4 = Fatty acid binding protein 4, FAAA = fumarylacetoacetase, PTPRD = Receptor-type tyrosine-protein phosphatase delta, INHBC = Inhibin beta C chain, SHBG = sex hormone binding globulin, PILR A-A NP = PILR alpha-associated neural protein.}
\centering
\begin{tabu} to \linewidth {>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X}
\toprule
...
{\centering \includegraphics[width=0.9\linewidth]{figure/BMI_protein_INTERVAL/BMI_proteins_2SMR} 
...
\begin{tabu} to \linewidth {>{\raggedright}X>{\raggedright}X>{\raggedright\arraybackslash}p{2cm}>{\raggedright\arraybackslash}p{2cm}>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X}
\toprule
Exposure & Outcome & Outcome ID & Method & N SNP & Beta coefficient & SE & Pval & Q & Q df & Q pval & Egger intercept & SE & Egger intercept Pval\\
\midrule
...
{\centering \includegraphics[width=0.9\linewidth]{figure/BMI_protein_INTERVAL/FAH_comparison} 
...
\caption[Disease enrichment of proteins associated with BMI in confounder adjusted model compared with all proteins in SomaLogic (DAVID Bioinformatics 6.8)]{\label{tab:DAVID-enrichment-obs}\textbf{Disease enrichment of proteins associated with BMI in confounder adjusted model compared with all proteins in SomaLogic (DAVID Bioinformatics 6.8)\textsuperscript{\protect\hyperlink{ref-Huang2009}{175}}}}
\centering
\begin{tabu} to \linewidth {>{\raggedright\arraybackslash}p{5cm}>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X}
\toprule
Term (Genetic Association Database disease class) & Count & \% & List Total &   Population Hits & Population Total & Fold Enrichment & P Value & Bonferroni-adjusted P value\\
...
{\centering \includegraphics[width=0.8\linewidth]{figure/DiRECT/Thesis_graphic_overview_BMI_protein_CVD_arrows} 
...
\caption{\label{tab:DAVID-enrichment-DiRECT}\textbf{DiRECT protein enrichment results for disease class using DAVID bioinformatics 6.8\textsuperscript{\protect\hyperlink{ref-Huang2009}{175}}}}
\centering
\begin{tabu} to \linewidth {>{\raggedright\arraybackslash}p{5cm}>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X}
\toprule
Term (Genetic Association Database disease class) & Count & \% & List Total &   Population Hits & Population Total & Fold Enrichment & P Value & Bonferroni-adjusted P value\\
...
The proteins with causal evidence in the MR analysis from Chapter \ref{BMI-protein-MR} were explored in the RCT results. Out of the eight unique proteins in INTERVAL, five of them were in the DiRECT SomaLogic panel. These were fumarylacetoacetase (FAAA), Inhibin beta C chain (INHBC), Complement C5, SHBG and PILR. Three of these displayed consistent estimates across studies, whereas Complement C5 and PILR were not associated with BMI change in DiRECT (Figure \ref{fig:DiRECT-INTERVAL-signif}).



\begin{figure}

{\centering \includegraphics[width=0.75\linewidth]{figure/DiRECT/INTERVAL_signif_DiRECT_forest} 

}

\caption[Forest plot comparing the protein effect estimates in INTERVAL and DiRECT (where there was MR evidence for a causal effect)]{\textbf{Forest plot comparing the protein effect estimates in INTERVAL and DiRECT (where there was MR evidence for a causal effect)}. Proteins presented are the only proteins out of the top eight that were detected in DiRECT.}\label{fig:DiRECT-INTERVAL-signif}
\end{figure}
All BMI-protein estimates from DiRECT were then compared with effect estimates from INTERVAL (Chapter \ref{BMI-protein-MR}), where 2803 proteins were detected across both studies. Both cohorts, through use of different study designs, provided evidence for an effect of BMI on the plasma proteome. Figure \ref{fig:DiRECT-INTERVAL} shows the BMI-protein estimates for the proteins which were included in both DiRECT and INTERVAL (R\textsuperscript{2}=0.11, P=1.0x10\textsuperscript{77}).

The overall protein effects were either deemed as similar, different or extreme (similar with large estimate) based on the comparison of scaled estimates. There was evidence that 2119 proteins had a similar effect across studies, 478 were different and 206 were extreme. There was consistent evidence across both studies that higher BMI leads to higher levels of various proteins including fumarylacetoacetase (FAAA), INHBC, alcohol dehydrogenase 4 (ADH4), growth hormone receptor (GHR) and carboxypeptidase M (CBPM). Furthermore, higher BMI had a lowering effect on levels of sex hormone binding globulin (SHBG), as well as insulin-like growth factor binding protein 1/2 (IGFBP1/2). Although some of these estimates did not pass multiple testing in INTERVAL, the concordance in estimates in terms of effect size and direction of effect suggests that this is an issue of power.
...
{\centering \includegraphics[width=0.75\linewidth]{figure/DiRECT/DiRECT_INTERVAL_comparison_1.5SD} 
...
{\centering \includegraphics[width=0.75\linewidth]{figure/DiRECT/DiRECT_INTERVAL_comparison_groups_1.5SD} 
...
{\centering \includegraphics[width=1.1\linewidth]{figure/DiRECT/All_protein_platelet_1.5SD} 
...
{\centering \includegraphics[width=0.8\linewidth]{figure/General_discussion/Thesis_graphic_overview_chapters_arrows} 
...
\CSLLeftMargin{44. }
\CSLRightInline{Durrant, T. N. \emph{et al.} In-depth PtdIns(3,4,5)P3 signalosome analysis identifies DAPP1 as a negative regulator of GPVI-driven platelet function. \emph{Blood Adv} \textbf{1}, 918--932 (2017).}
