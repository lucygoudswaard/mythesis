...
\end{verbatim}
\begin{verbatim}
Warning in column_spec(., 1, width = "4cm"): Please specify format in
kable. kableExtra can customize either HTML or LaTeX outputs. See https://
haozhu233.github.io/kableExtra/ for details.
\end{verbatim}
\begin{verbatim}
Warning in column_spec(., 3, width = "2cm"): Please specify format in
kable. kableExtra can customize either HTML or LaTeX outputs. See https://
haozhu233.github.io/kableExtra/ for details.
\end{verbatim}
\begin{verbatim}
...
\end{verbatim}
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.38}}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.06}}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.05}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.05}}@{}}
\caption{\label{tab:INT-confounders-BMI-platelets}\textbf{Associations between age, sex, smoking and alcohol consumption (exposures) with standardised BMI (outcome).} Beta coefficient is the change in BMI (normalized SDs) per unit increase in exposure.}\tabularnewline
\toprule
Variable & N & Beta coefficient per 1-unit increase in confounder (SDs) & Standard error & P value & Adjusted R\textsuperscript{2} & F statistic & 95\% CI & Lower 95\% CI & Upper 95\% CI \\
\midrule
\endfirsthead
\toprule
Variable & N & Beta coefficient per 1-unit increase in confounder (SDs) & Standard error & P value & Adjusted R\textsuperscript{2} & F statistic & 95\% CI & Lower 95\% CI & Upper 95\% CI \\
...
Alcohol intake frequency (1=rarely, 2=\textless1 a week, 3=1-2 times a week, 4=most days/every day) & 29538 & -0.096 & 0.006 & 1.57e-61 & 0.009 & 275 & 0.011 & -0.108 & -0.085 \\
...
\end{verbatim}
\begin{verbatim}
Warning in column_spec(., 1, width = "3cm"): Please specify format in
kable. kableExtra can customize either HTML or LaTeX outputs. See https://
haozhu233.github.io/kableExtra/ for details.
\end{verbatim}
\begin{verbatim}
...
\end{verbatim}
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.23}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.06}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.03}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.09}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.03}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.05}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.03}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.05}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.04}}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.19}}@{}}
\caption{\label{tab:BMI-platelets-MR}\textbf{Mendelian randomization estimates for the effect of BMI on platelet traits.} Beta coefficient is the change in platelet measure in SDs per SD higher BMI.}\tabularnewline
\toprule
Full name & Short Name & N & Βeta coefficient & SE & P value & R\textsuperscript{2} & Eta\textsuperscript{2} & 95\% CI & Lower 95\% CI & Upper 95\% CI & Wu-Hausman P value & F-statistic (GRS and BMI association) \\
\midrule
\endfirsthead
\toprule
Full name & Short Name & N & Βeta coefficient & SE & P value & R\textsuperscript{2} & Eta\textsuperscript{2} & 95\% CI & Lower 95\% CI & Upper 95\% CI & Wu-Hausman P value & F-statistic (GRS and BMI association) \\
...
\end{verbatim}
\begin{verbatim}
Warning in column_spec(., 1, width = "2.5cm"): Please specify format in
kable. kableExtra can customize either HTML or LaTeX outputs. See https://
haozhu233.github.io/kableExtra/ for details.
\end{verbatim}
\begin{verbatim}
Warning in column_spec(., 2, width = "2.5cm"): Please specify format in
kable. kableExtra can customize either HTML or LaTeX outputs. See https://
haozhu233.github.io/kableExtra/ for details.
\end{verbatim}
\begin{verbatim}
...
\end{verbatim}
\begin{verbatim}
Warning in add_indent(., c(3, 4, 7:11, 13:16), level_of_indent = 1): Please
...
\caption{\label{tab:COPTIC-participants-platelets}\textbf{Characteristics of COPTIC study participants}}\tabularnewline
\toprule
...
Smoking & & 2469 & & 654 \\
Never & 38.5 \% & & 50.8 \% & \\
Ex-smoker (\textgreater5 years) & 47.4 \% & & 38.4 \% & \\
Ex-smoker (1-5 years) & 8.3 \% & & 6.3 \% & \\
Ex-smoker (30 days to 1 year) & 1.9 \% & & 2.1 \% & \\
Current smoker & 3.9 \% & & 2.4 \% & \\
...
Platelet count (x 10\textsuperscript{9}/L) & 209.8 (60.5) & 2409 & 200.9 (57.6) & 637 \\
Mean platelet volume (fL) & 10.6 (1.0) & 2400 & 10.6 (0.98) & 634 \\
Immature platelet fraction (\%) & 3.2 (1.9) & 2379 & 3.3 (2.0) & 628 \\
Immature platelet count (x 10\textsuperscript{9}/L) & 6.3 (3.4) & 2383 & 6.2 (3.3) & 629 \\
\bottomrule
\end{longtable}
...
\toprule
Outcome & N & Βeta coefficient & SE & P value & R\textsuperscript{2} & 95\% CI & Lower 95\% CI & Upper 95\% CI \\
\midrule
\endfirsthead
\toprule
Outcome & N & Βeta coefficient & SE & P value & R\textsuperscript{2} & 95\% CI & Lower 95\% CI & Upper 95\% CI \\
...
\end{verbatim}
\begin{verbatim}
Warning in add_indent(., c(8, 9, 10), level_of_indent = 1): Please specify
...
\end{verbatim}
\begin{verbatim}
Warning in column_spec(., 1, width = "5cm"): Please specify format in
kable. kableExtra can customize either HTML or LaTeX outputs. See https://
haozhu233.github.io/kableExtra/ for details.
\end{verbatim}
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.21}}@{}}
\caption{\label{tab:obesity-platelets-participants}\textbf{Characteristics of included participants in the body mass index and platelet function study}}\tabularnewline
\toprule
...
Sex & 75 \% & 75 \% & 1 \\
Body mass index (kg/m\textsuperscript{2}) & 21.8 (2.1) & 49.3 (8.8) & 9e-04 \\
Smoker & 0 \% & 0 \% & 1 \\
...
\end{verbatim}
\begin{verbatim}
Warning in add_indent(., c(3, 4, 9, 10, 11, 13, 14, 15, 16), level_of_indent
= 1): Please specify format in kable. kableExtra can customize either HTML or
...
\end{verbatim}
\begin{verbatim}
Warning in column_spec(., 1, width = "6cm"): Please specify format in
kable. kableExtra can customize either HTML or LaTeX outputs. See https://
haozhu233.github.io/kableExtra/ for details.
\end{verbatim}
\begin{verbatim}
...
\caption{\label{tab:Inc-excl-part}\textbf{Comparison of included vs excluded INTERVAL participants for the BMI-proteome analysis}}\tabularnewline
\toprule
...
Body mass index (kg/m\textsuperscript{2}) & 25.9 (4.8) & 2729 & 26.4 (4.7) & 30659 & 0.66 \\
Smoking frequency & & 2675 & & 29958 & 0.88 \\
Never & 59.10\% & & 59.40\% & & \\
Occasional & 11.90\% & & 12.00\% & & \\
Most days or every day & 29.00\% & & 28.50\% & & \\
Alcohol intake frequency & & 2422 & & 27124 & 0.34 \\
Rarely & 11.70\% & & 12.60\% & & \\
Less than once a week & 16.90\% & & 17.10\% & & \\
One or two times a week & 37.40\% & & 37.70\% & & \\
Three to five times a week / most days & 34.10\% & & 32.50\% & & \\
\bottomrule
\end{longtable}
...
\end{verbatim}
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.39}}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.05}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.05}}@{}}
\caption{\label{tab:INT-confounders-BMI}\textbf{Associations between covariables (exposure) and standardised BMI (outcome)}}\tabularnewline
\toprule
Variable & N & Beta coefficient per 1-unit increase in confounder (SDs) & Standard error & P value & Adjusted R\textsuperscript{2} & F statistic & 95\% CI & Lower 95\% CI & Upper 95\% CI \\
\midrule
\endfirsthead
...
Alcohol intake frequency (1=rarely, 2=\textless1 a week, 3=1-2 times a week, 4=most days/every day) & 2415 & 0.021 & 0.021 & 7.08e-05 & 0.006 & 15.8 & 0.041 & -0.12 & -0.04 \\
\bottomrule
\end{longtable}
...
\end{verbatim}
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.48}}
...
\caption{\label{tab:INT-GRS-confounders}\textbf{Associations of the genetic risk score for BMI with reported BMI and covariables}}\tabularnewline
\toprule
Variable & N & Beta coefficient (per 1-unit increase in GRS) & Standard error & P value & Adjusted R\textsuperscript{2} & F statistic \\
\midrule
\endfirsthead
\toprule
Variable & N & Beta coefficient (per 1-unit increase in GRS) & Standard error & P value & Adjusted R\textsuperscript{2} & F statistic \\
...
BMI (kg/m\textsuperscript{2}) & 2729 & 2.54 & 0.31 & 4.82e-16 & 0.024 & 66.68 \\
...
Alcohol intake frequency (1=rarely, 2=\textless1 a week, 3=1-2 times a week, 4=most days/every day) & 2422 & -0.06 & 0.07 & 0.44 & -2e-04 & 0.6 \\
\bottomrule
\end{longtable}
...
\caption[Disease enrichment of proteins associated with BMI in confounder adjusted model compared with all proteins in SomaLogic (DAVID Bioinformatics 6.8)]{\label{tab:DAVID-enrichment-obs}\textbf{Disease enrichment of proteins associated with BMI in confounder adjusted model compared with all proteins in SomaLogic (DAVID Bioinformatics 6.8)\textsuperscript{\protect\hyperlink{ref-Huang2009}{128}}}}
\centering
\begin{tabu} to \linewidth {>{\raggedright\arraybackslash}p{5cm}>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X}
\toprule
Term (Genetic Association Database disease class) & Count & \% & List Total &   Population Hits & Population Total & Fold Enrichment & P Value & Bonferroni-adjusted P value\\
...
\begin{figure}
\includegraphics[width=1.2\linewidth]{figure/DiRECT/QQ_plots_obs_IV} \caption[QQ-plots of the expected vs the observed -log\textsubscript{10}(p-values) for the BMI change-protein change effects]{\textbf{QQ-plots of the expected vs the observed -log\textsubscript{10}(p-values) for the BMI change-protein change effects}. A) Linear regression B) Instrumental variable two stage least squares analysis.}\label{fig:qq-plot-DiRECT}
\end{figure}
...
\caption{\label{tab:DAVID-enrichment-DiRECT}\textbf{DiRECT protein enrichment results for disease class using DAVID bioinformatics 6.8\textsuperscript{\protect\hyperlink{ref-Huang2009}{128}}}}
\centering
\begin{tabu} to \linewidth {>{\raggedright\arraybackslash}p{5cm}>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X}
\toprule
Term (Genetic Association Database disease class) & Count & \% & List Total &   Population Hits & Population Total & Fold Enrichment & P Value & Bonferroni-adjusted P value\\
