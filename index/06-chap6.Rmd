...
```{r chemokine-platelet-graphic, echo = FALSE , fig.scap="Schematic of the associations explored", fig.cap="Schematic of the associations explored: this chapter explores the effect of the chemokines MDC and TARC with platelet function and aims to explore their involvement in disease", out.width="90%"}
