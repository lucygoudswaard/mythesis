...
```{r BMI-protein-graphic2, echo = FALSE , fig.scap="Schematic of the associations explored in chapter", fig.cap="Schematic of the associations explored: this chapter explores the effect of caloric restriction-induced weight loss on the plasma proteome. Figure made using BioRender.com.", out.width="90%"}
...
(ref:caption-direct-tsls) Schematic of two stage least squares analysis. Figure made using BioRender.com.
